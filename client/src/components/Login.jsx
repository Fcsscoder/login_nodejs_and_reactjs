        ...
        {user == null ? (
            <div className='login-container'>
                ...
                <button 
                        ...
                        onClick={() => {toggleDiv()}}>Criar Conta</button>
            </div>
            ) : (
                <div className='user-connected-container'>
                    <div className='user-actions-container'>
                        ...
                        <button 
                            className='btn-login' 
                            onClick={(e) => toggleUpdateDiv()}>Editar usuário</button>
                        <form>
                            <input type="hidden" name="id" />
                            <button 
                                id='btn-removeuser' 
                                type='submit'
                                onClick={(e) => handleRemove(e)}>Apagar conta</button>
                        </form>
                    ...
                    <div className='edituser-container'>
                        ...
                        <form>
                            ...
                            <button 
                                ...
                                id='btn-edituser'
                                className='btn-back'
                                onClick={(e) => handleUpdate(e)}>Concluir</button>
                        </form>
                        <p>{error}</p>
                    </div>
                    }
